    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <header className="relative flex items-center justify-between px-8 py-5 max-w-[1120px] mx-auto animate-fade-in">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => navigate("/auth?tab=signup")} className="text-[13px] font-semibold text-primary-foreground bg-foreground hover:bg-foreground/90 transition-all px-5 py-2 rounded-lg">
            Get Started
          </button>
        </div>
      </header>
