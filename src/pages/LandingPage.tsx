    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <header className="relative flex items-center justify-between px-8 py-5 max-w-[1120px] mx-auto animate-fade-in">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-state-accent flex items-center justify-center shadow-lg shadow-primary/20">
      ...
      <section className="relative max-w-[1120px] mx-auto px-8 pt-24 pb-28 text-center">
        <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/[0.06] text-primary text-[12px] font-medium mb-8 ring-1 ring-inset ring-primary/10">
        ...
        <h1 className="text-[52px] font-bold text-foreground tracking-tight leading-[1.08] max-w-2xl mx-auto opacity-0 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          Your AI workforce,
          <br />
          <span className="font-display italic font-normal text-primary/80">always on</span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-3 mt-10 opacity-0 animate-fade-in-up" style={{ animationDelay: "0.5s" }}>
          <button onClick={() => navigate("/auth?tab=signup")} className="text-[14px] font-semibold text-primary-foreground bg-primary hover:brightness-110 transition-all px-7 py-3 rounded-xl shadow-lg shadow-primary/25 flex items-center gap-2 glow-primary">
      ...
      <section className="relative max-w-[1120px] mx-auto px-8 pb-28">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 animate-stagger">
          <div className="card-premium rounded-2xl border border-border p-8 relative noise-overlay group">
            <div className="w-12 h-12 rounded-2xl bg-state-working/[0.08] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
              <Users className="w-5.5 h-5.5 text-state-working" />
            </div>
            <h3 className="text-[16px] font-semibold text-foreground mb-2">Durable employees</h3>
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              AI employees that persist, learn, and improve over time — not one-off prompts that forget everything.
            </p>
          </div>
          <div className="card-premium rounded-2xl border border-border p-8 relative noise-overlay group">
            <div className="w-12 h-12 rounded-2xl bg-primary/[0.08] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="card-premium rounded-2xl border border-border p-8 relative noise-overlay group">
            <div className="w-12 h-12 rounded-2xl bg-state-accent/[0.08] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
              <Globe className="w-5.5 h-5.5 text-state-accent" />
            </div>
            <h3 className="text-[16px] font-semibold text-foreground mb-2">Connected to your tools</h3>
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              Slack, Lark, Email, Salesforce — your AI employees work where your team already works.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="relative border-t border-border py-8 text-center">
        <p className="text-[11px] text-muted-foreground">© 2025 Agens.run · AI employees for modern teams</p>
      </footer>
    </div>
  );
}
