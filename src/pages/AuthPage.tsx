...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel */}
      <div className="hidden lg:flex w-[480px] flex-shrink-0 sidebar-gradient flex-col justify-between p-10">
        <div>
          ...
          <h2 className="text-[28px] font-bold text-sidebar-primary leading-tight tracking-tight mb-4">
            Hire AI employees<br />that actually work
          </h2>
          <p className="text-[14px] text-sidebar-muted leading-relaxed mb-10">
        ...
        <p className="text-[11px] text-sidebar-muted">© 2025 Agens.run</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[380px]">
          ...
          {/* Google mock */}
          <button className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-border bg-card text-[13px] font-medium text-foreground hover:bg-muted/50 transition-colors mb-5">
